...
$chat .= '<tr><td colspan=2><select id="chat" onmouseover=listConvo()><option default id="chatters" value="" label="You have 1 people to chat with.">-- User Queue --</select></td></tr>';
