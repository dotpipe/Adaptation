...
$form .= '<input id="insWrd" onkeypress="keywordLookup(this,event.keyCode);" style="display:table-cell;width:90%;color:black;border-radius:10px;border:0px;"></div>';
$form .= '<div id="div-keys" style="display:table"></div>';
