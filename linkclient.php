...
$form .= '<input required id="no" style="background:white" name="city" type="text" placeholder="City"> <b style="color:red">*</b><br>';
$form .= '<input required id="no" style="background:white" name="state" type="text" placeholder="State"> <b style="color:red">*</b><br>';
$form .= '<input id="store_email" style="background:white" name="store_email" type="email" placeholder="Store Email"><br>';
