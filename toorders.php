<?php
    ...
    function myOrders() {
        ...
        $info = "<table style='text-align:center;font-size:13px;color:lightgray;border:2px solid darkblue' id='order'><tr><td>Order #</td><td>Customer</td><td>Product</td><td>Qu</td><td>Price</td><td>Total</td><td>TOA</td><td>Created</td><td>Action</td></tr>";
