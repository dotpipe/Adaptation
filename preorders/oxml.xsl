<?xml-stylesheet type="text/xml" version="1.0" encoding="UTF-8"?>
	...
	#in-window { border:2px solid darkblue;overflow-wrap:break-word;overflow-y:scroll;color:lightgray;background:black;height:300px;width:250px; }
  </style>
		<xsl:for-each select="preorders/items">
