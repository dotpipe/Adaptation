...
$chat .= '<div id=\'in-window\' style=\'border:2px solid darkblue;overflow-wrap:break-word;overflow-y:scroll;color:lightgray;background:black;height:300px;width:250px\'>';
$chat .= '<br><br><br><br><br><center><a onclick=getInbox(\'s\',this)>Click to begin</a><center></div></td></tr><tr><td colspan=2 style=\'text-align:center;background:black;\'>';
